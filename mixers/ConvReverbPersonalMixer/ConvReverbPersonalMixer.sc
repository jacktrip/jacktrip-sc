...
/*
 * ConvReverbPersonalMixer: automatically pans clients across a stereo sound field,
...
ConvReverbPersonalMixer : PersonalMixer {
    ...
    //var<> reverb_irPath = "C:/Users/mike/OneDrive/Documents/Impulses/EchoThiefImpulseResponseLibrary/Venues/MillsGreekTheater.wav";
    ...
    *new { | maxClients = 16 |
    ...
    start {
        ...
        this.postChain.append(ConvReverbLink().mix_(reverb_mix).low_(reverb_low).high_(reverb_high).irPath_(reverb_irPath));
